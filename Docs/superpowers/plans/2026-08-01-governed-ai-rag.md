...
- `database/migrations/V015__governed_ai_runtime.sql`: governed-AI tables, functions, indexes, and grants.
...
**Files:**
- Create: `database/migrations/V015__governed_ai_runtime.sql`
